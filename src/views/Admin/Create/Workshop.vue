  ...
  <div class="services">
    ...
    <div class="custom-form elevation-2 mt-3">
      <v-form
        ...
        v-model="valid"
        lazy-validation
        v-for="(service, index) in $store.getters.getWorkshops"
        :key="service.id"
...
export default {
  ...
  data() {
    return {
      headingObj: {
        h1: "Workshop",
        h4:
          "Create a new workshop annoucement for people to participate & learn",
        src: "workshop.svg",
      },
      subHeadingObj: {
        h1: "Saved Workshops",
        h4: "View, edit or delete created workshop announcements",
        src: "workshop.svg",
      },
      post: {
  ...
  methods: {
    ...
    deleteService(id) {
      let serviceDetails = { id: id, serviceType: "Workshops" };
      this.$store
