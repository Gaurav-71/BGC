  ...
  <div class="services">
    ...
    <div class="custom-form elevation-2 mt-3">
      <v-form
        ...
        v-model="valid"
        lazy-validation
        v-for="(service, index) in $store.getters.getInternships"
        :key="service.id"
...
export default {
  ...
  data() {
    return {
      ...
      subHeadingObj: {
        h1: "Saved Internships",
        h4: "View, edit or delete created internship positions",
        src: "internship.svg",
      },
      post: {
  ...
  methods: {
    ...
    deleteService(id) {
      let serviceDetails = { id: id, serviceType: "Internships" };
      this.$store
